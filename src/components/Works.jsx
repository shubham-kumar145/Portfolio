    ...
    <>
      ...
      <div>
        ...
        <div className="text-center mb-12">
          ...
          <div className="mt-3 mx-auto w-20 h-[3px] rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500" />
          <p className="mt-3 text-slate-500 text-xs tracking-[0.25em] uppercase font-serif">
